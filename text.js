...
function exibirMensagemDoDia() {
	...
	"2024-01-05": ["Em que nível subatômico", "nossos corações dançam", "em um entrelaçamento quântico de amor?", "~", "Em um emaranhamento de destinos,", "nossos corações dançam como partículas entrelaçadas.", "Na mecânica quântica do amor,", "somos como átomos conectados por forças invisíveis.", "Nossos momentos juntos são como superposição de estados,", "onde a incerteza se dissolve na certeza de que,", "mesmo em diferentes espaços, nossas ondas se encontram.", "~", "Qual é essa partícula subatômica que representa nosso vínculo,", "onde a medida de nossos sentimentos é", "sempre precisa e imprevisível?"],
    };
